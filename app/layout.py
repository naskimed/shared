...
def create_layout():
    ...
    # Introduction of dcc.Store to store the data
    dcc.Store(id='clientside-stored-nav', data={}),
    dcc.Store(id='clientside-stored-performance', data={}),
    dcc.Store(id='clientside-stored-buy-pipeline-size', data={}),
    dcc.Store(id='clientside-stored-sell-pipeline-size', data={}),
    dcc.Store(id='clientside-stored-cash', data={}),
    dcc.Store(id='clientside-stored-weights', data={}),
    dcc.Store(id='clientside-stored-performance-attribution', data={}),
    dcc.Store(id='clientside-stored-hit-ratio-performance', data={}),
    dcc.Store(id='clientside-stored-win-loss-performance', data={}),
    dcc.Store(id='clientside-stored-hit-ratio-win-loss', data={}),
    dcc.Store(id='clientside-stored-data-table', data={}),
    dcc.Store(id='clientside-stored-steps', data={}),
    dcc.Store(id='clientside-stored-interval-component', data={}),
    dcc.Store(id='clientside-stored-total-return', data={}),
    dcc.Store(id='clientside-stored-volatility', data={}),
    dcc.Store(id='clientside-stored-IR', data={}),
    dcc.Store(id='clientside-stored-max-dropdown', data={}),
    dcc.Store(id='clientside-stored-hit-ratio', data={}),
    dcc.Store(id='clientside-stored-win-loss-ratio', data={}),
    dcc.Store(id='clientside-stored-stored', data={}),
    dcc.Store(id='clientside-stored-line-chart', data={}),
    dcc.Store(id='clientside-stored-line-chart2', data={}),
    ...
    dcc.Interval(id='interval-component', interval=30000, n_intervals=1, disabled=True),
    
    dcc.Interval(id='clientside-interval', interval=30000, n_intervals=0),
